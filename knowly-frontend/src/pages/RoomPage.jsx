  ...
  return <>
    ...
    <div className="min-h-screen bg-gray-50 px-4 py-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-7"><p className="text-blue-600 font-semibold">PRIVATE LEARNING SPACE</p><h1 className="text-3xl font-bold text-gray-900 mt-1">Your Rooms</h1><p className="text-gray-600 mt-2">Each room is its own private learning space with its own workshops and members.</p></div>
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          ...
          {activeRoom && <button onClick={() => navigate('/workshops/create', { state: { returnTo: '/room' } })} className="border border-blue-200 bg-white text-blue-600 px-5 py-2.5 rounded-lg font-medium hover:bg-blue-50">+ Create Workshop in {activeRoom.name}</button>}
        </div>
