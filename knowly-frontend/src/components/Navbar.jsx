    ...
    <nav className="bg-white border-b border-gray-200 relative z-40">
      <div className="max-w-6xl mx-auto px-4">
        <div className="h-16 flex items-center justify-between gap-3">
          ...
          <div className="hidden md:flex items-center gap-5">
            {NAV_LINKS.map((link) => (
              <button
                ...
                className={`text-sm font-medium transition whitespace-nowrap ${link.match(location.pathname)
                    ? 'text-blue-600'
          ...
          {/* Right side: notifications, account, mobile menu toggle */}
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                <span className="w-8 h-8 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center font-semibold shrink-0">
            ...
            <button
              ...
              className="md:hidden flex items-center justify-center w-9 h-9 rounded-lg text-gray-600 hover:bg-gray-100 hover:text-blue-600 transition"
          ...
          <div className="md:hidden border-t border-gray-200 py-3 flex flex-col gap-1">
            {NAV_LINKS.map((link) => (
              <button
                key={link.path}
                onClick={() => goTo(link.path)}
                className={`text-left px-2 py-2.5 rounded-lg text-sm font-medium transition ${link.match(location.pathname)
