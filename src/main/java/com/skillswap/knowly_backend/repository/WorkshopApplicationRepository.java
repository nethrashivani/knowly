...
public interface WorkshopApplicationRepository extends JpaRepository<WorkshopApplication, Long> {
    ...
    Optional<WorkshopApplication> findByWorkshop_IdAndLearner_Email(Long workshopId, String email);
    Optional<WorkshopApplication> findByWorkshop_IdAndLearner_Id(Long workshopId, Long learnerId);
}